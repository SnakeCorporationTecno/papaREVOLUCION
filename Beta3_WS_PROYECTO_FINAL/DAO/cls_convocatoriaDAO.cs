...
namespace Beta3_WS_PROYECTO_FINAL.DAO
{
    public class cls_convocatoriaDAO
    {
        ...
        public int AgregarConvocatoria(cls_convocatoriaBO obj_conv)
        {
        ...
        public int ModificarConvocatoria(cls_convocatoriaBO obj_conv)
        {
        ...
        public int EliminarConvocatoria(cls_convocatoriaBO obj_conv)
        {
